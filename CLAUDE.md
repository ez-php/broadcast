...
└── Driver/
    ...
    └── RedisDriverTest.php     — covers RedisDriver: publish, multi-channel; requires live Redis (#[Group('redis')]) — module stack `redis` service (host port 6384), CI `redis` service container, or the root stack
```
